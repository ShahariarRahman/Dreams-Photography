...
const Footer = () => {
    ...
    return (
        <footer className='bg-sky-700 relative'>
            <div className='max-w-screen-2xl m-auto'>
                <div className="sm:flex sm:items-center sm:justify-between p-6">
                    <span className="text-sm text-sky-500 sm:text-center dark:text-black">&copy; {year} <a href="https://www.google.com/" className="hover:underline">Dream Photography</a>. All Rights Reserved.
                    </span>
