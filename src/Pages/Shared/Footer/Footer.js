...
const Footer = () => {
    ...
    return (
        <div className='bg-gray-200 h-screen relative'>
            <div className=' bg-gray-800 absolute bottom-0 w-full'>
                <div className="sm:flex sm:items-center sm:justify-between p-8">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">&copy; {year} <a href="https://www.google.com/" className="hover:underline">Dream Photography</a>. All Rights Reserved.
                    </span>
                    <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        <a href="https://www.google.com/" className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
