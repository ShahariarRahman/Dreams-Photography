...
const Blogs = () => {
    return (
        <div>
            <div className='flex justify-center mt-4 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-gray-800 mb-10 '>
                <div className='w-3/4 h-3/4 shadow-xl hover:shadow-2xl flex flex-col items-center rounded-xl p-10 '>
                    <div className='w-full px-4'>
                        ...
                        <h4 className='text-lg mt-2'> <span > Answer: </span>
                        ...
                        <h3 className='text-lg mt-4'> 2. Why are you using firebase? What other options do you have to implement authentication?</h3>
                        <h4 className='text-lg mt-2'> <span>Answer: </span>
                            <ul className='font-thin'>
                                <li>Firebase is helpful for realtime database, cloud storage, machine learning, hosting, etc.
                                </li>
                                <li>
                        ...
                        <h3 className='text-lg mt-4'>3. What other services does firebase provide other than authentication.</h3>
                        <h4 className='text-lg mt-2'> <span >Answer: </span>
                            <ul className='font-thin'>
